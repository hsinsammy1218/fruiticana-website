...
- [ ] Product photography of the actual frozen dessert (a 4 oz cup) — owner-provided asset needed. The school-kitchens section currently uses cropped historical scoop imagery from the 2007 myfruiticana.com site (`public/images/brand/school-scoops.webp`); replace with a current cup photo when available.
