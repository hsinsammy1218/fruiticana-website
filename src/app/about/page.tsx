    ...
    <>
      ...
      <Section id="documentation" tone="white" className="scroll-mt-24">
        <SectionHeading
          ...
          description="Fruiticana's business record includes documents from roughly 2004-2008. Open any document to read it on its own page for school review. The U.S. FDA facility registration PDF is available to download; other original PDF downloads are not published."
        />
